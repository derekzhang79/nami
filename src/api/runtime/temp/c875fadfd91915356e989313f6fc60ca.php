<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"D:\wamp64\www\webPrj\xiaomi\src\api\public/../application/admin\view\category\edit.html";i:1499341287;s:87:"D:\wamp64\www\webPrj\xiaomi\src\api\public/../application/admin\view\public\header.html";i:1499313462;s:87:"D:\wamp64\www\webPrj\xiaomi\src\api\public/../application/admin\view\public\footer.html";i:1499477121;}*/ ?>
<!DOCTYPE html>
...
<h2>修改分类表单</h2>
<div>
	<a href="<?php echo url('index'); ?>" class="btn btn-success">返回分类列表</a>
</div>
<form action="<?php echo url('update'); ?>" enctype="multipart/form-data" method="post">
	<div class="form-group">
		<label for="">分类名称</label>
		<input type="text" class="form-control" name="cate_name" value="<?php echo $info['cate_name']; ?>"></div>
 
	<div class="form-group">
		<label for="">所属分类</label>
		<select name="parent_id" >
			<option value="">请选择</option>
			<option value="0" <?php if($info['parent_id'] == 0): ?>selected <?php endif; ?>>无</option>
			<?php foreach($category_list as $item): ?>
			<option <?php if($info['parent_id'] == $item['id']): ?>selected <?php endif; ?> value="<?php echo $item['id']; ?>">
	...
	<div class="form-group">
		...
		<input type="file"  name="cate_thumb" class="thumb" data-default-file="__PUBLIC__<?php echo $info['cate_thumb']; ?>"></div>
