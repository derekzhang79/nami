...
<div class="row">
	...
	<div class="col-lg-6 pull-right">
		<form action="<?php echo url('index'); ?>">
			...
			商品分类:
			<select name="category_id" id="category_box">
...
<table class="table">
	...
	<tr>
		<td>
			<input type="checkbox" name="ids[]" value="<?php echo $item['id']; ?>"></td>
