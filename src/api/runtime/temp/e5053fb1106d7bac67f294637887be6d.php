<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:88:"D:\wamp64\www\webPrj\xiaomi\src\api\public/../application/admin\view\personal\order.html";i:1499328581;s:87:"D:\wamp64\www\webPrj\xiaomi\src\api\public/../application/admin\view\public\header.html";i:1499313462;s:87:"D:\wamp64\www\webPrj\xiaomi\src\api\public/../application/admin\view\public\footer.html";i:1498447872;}*/ ?>
<!DOCTYPE html>
...
<table class="table">
    ...
    <tr>
        ...
        <td><?php echo $list['goods_price']; ?></td>
        <td><?php echo $list['carry_price']; ?></td>
        <td><?php echo $list['total_price']; ?></td>
        <td><?php echo $list['consignee']; ?></td>
        <td><?php echo $list['phone_num']; ?></td>
        <td><?php echo $list['address']; ?></td>
        <th><?php echo $list['status']; ?></th>
        <td>
 ...
 <!-- BEGIN FOOTER -->
        ...
        <nav class="quick-nav">
            ...
            <ul>
                <li>
                    <a href="<?php echo url('order/index'); ?>"  class="active">
                        <span>订单管理</span>
                        <i class="icon-basket"></i>
                    </a>
                </li>
