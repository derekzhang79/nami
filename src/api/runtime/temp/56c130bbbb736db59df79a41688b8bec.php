...
<table class="table">
    ...
    <?php foreach($cart_list as $list): ?>
    <tr>
        <td><?php echo $list['id']; ?></td>
        <th><?php echo $list['user_id']; ?></th>
        <th><?php echo $list['goods_name']; ?></th>
        <th><?php echo $list['goods_attr2']; ?></th>
        <th><?php echo $list['goods_price']; ?></th>
        <td>
            <a href='' class="btn btn-info">预览</a>
