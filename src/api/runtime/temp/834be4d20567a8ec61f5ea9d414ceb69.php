...
<h1 class="page-title"> 纳米商城后台管理系统
                            <small><a href="<?php echo url('goods/index'); ?>">商品管理</a>、<a href="<?php echo url('category/index'); ?>">分类管理</a>、订单管理</small>
                        </h1>
 <div class="row">
                            ...
                            <div class="col-lg-12 col-xs-12 col-sm-12">
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <span class="caption-subject bold uppercase font-dark">会员注册时时监控</span>
                                        </div>
                                        <div class="actions">
                                    ...
                                    <script type="text/javascript" src="__PUBLIC_ADMIN__/static/library/echarts.min.js"></script>
