...
<div class="row">
	<div class="col-lg-3">
		<?php if($parent_id): ?>
		<a href="<?php echo url('index'); ?>" class="btn btn-success">返回一级分类</a>
		<?php endif; ?>
...
<form action="<?php echo url('recommed'); ?>">
<table class="table">
	<tr>	 
		<th>ID</th>
		<th>分类名称</th>
	...
	<tr>
		...
		<td>
			...
			<a href='<?php echo url("index",array("parent_id"=>$item['id'])); ?>' class="btn btn-info">查看子类</a>
			<?php endif; ?>

			<a href='<?php echo url("edit",array("id"=>$item['id'])); ?>' class="btn btn-info">修改</a>

			<a href='<?php echo url("delete",array("id"=>$item['id'],"pid"=>$item['parent_id'])); ?>' class="btn btn-danger">删除</a>
		</td>
	</tr>
	<?php endforeach; ?>	 
</table>
