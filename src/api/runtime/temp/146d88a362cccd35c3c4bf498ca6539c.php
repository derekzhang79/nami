<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"D:\wamp64\www\nami\src\api\public/../application/admin\view\goods\edit.html";i:1499784842;s:78:"D:\wamp64\www\nami\src\api\public/../application/admin\view\public\header.html";i:1499784811;s:78:"D:\wamp64\www\nami\src\api\public/../application/admin\view\public\footer.html";i:1499785187;}*/ ?>
<!DOCTYPE html>
...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
        ...
        <link href="__PUBLIC_ADMIN__/static/admin/css.css" rel="stylesheet" type="text/css">
        <link href="__PUBLIC_ADMIN__/static/library/fontasome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
        <link href="__PUBLIC_ADMIN__/static/admin/simple-line-icons.css" rel="stylesheet" type="text/css">
        <link href="__PUBLIC_ADMIN__/static/admin/bootstrap.css" rel="stylesheet" type="text/css">
        <link href="__PUBLIC_ADMIN__/static/admin/bootstrap-switch.css" rel="stylesheet" type="text/css">
        <!-- END GLOBAL MANDATORY STYLES -->
        <!-- BEGIN THEME GLOBAL STYLES -->

        <link href="__PUBLIC_ADMIN__/static/admin/components.css" rel="stylesheet" id="style_components" type="text/css">
        <link href="__PUBLIC_ADMIN__/static/admin/plugins.css" rel="stylesheet" type="text/css">
        
        <!-- END THEME GLOBAL STYLES -->
        <!-- BEGIN THEME LAYOUT STYLES -->
   

        <link href="__PUBLIC_ADMIN__/static/admin/theme2/layout.min.css" rel="stylesheet" type="text/css" />
        <link href="__PUBLIC_ADMIN__/static/admin/theme2/blue.min.css" rel="stylesheet" type="text/css" id="style_color" />


        <script src="__PUBLIC_ADMIN__/static/admin/jquery_002.js" type="text/javascript"></script>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-header navbar navbar-fixed-top">
               ...
               <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    <a href="index.html">
                        <img src="__PUBLIC_ADMIN__/static/admin/logo-default.png" alt="logo" class="logo-default"> </a>
                    ...
                    <div class="top-menu">
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown dropdown-user">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <img alt="" class="img-circle" src="__PUBLIC_ADMIN__/static/admin/avatar3_small.jpg">
...
<form action="<?php echo url('update'); ?>" enctype="multipart/form-data" method="post">
	<div class="form-group">
		<label for="">商品名称</label>
		<input type="text" class="form-control" name="goods_name" value="<?php echo $info['goods_name']; ?>"></div>
	<div class="form-group">
		<label for="">商品价格</label>
		<input type="text" class="form-control" name="goods_price" value="<?php echo $info['goods_price']; ?>"></div>
	<div class="form-group">
		<label for="">所属分类</label>
		<select name="cate_id" >
			<option value="">请选择</option>
			<?php foreach($category_list as $item): ?>
			<option <?php if($info['cate_id'] == $item['id']): ?>selected <?php endif; ?> value="<?php echo $item['id']; ?>">
	...
	<div class="form-group" >
		<div><label for="">商品图片</label></div>
		<input type="file"  name="goods_image" class="thumb" data-default-file="__PUBLIC_ADMIN__<?php echo $info['goods_image']; ?>">
		<input type="file"  name="pic_1" class="thumb" data-default-file="__PUBLIC_ADMIN__<?php echo $info['pic_1']; ?>">
		<input type="file"  name="pic_2" class="thumb" data-default-file="__PUBLIC_ADMIN__<?php echo $info['pic_2']; ?>">
        <input type="file"  name="pic_3" class="thumb" data-default-file="__PUBLIC_ADMIN__<?php echo $info['pic_3']; ?>">
		</div>
	...
	<div class="form-group">
		...
		<textarea name="goods_deta" id="description"  style="width: 100%; height: 190px;"><?php echo $info['goods_deta']; ?></textarea>
	</div>
	<div class="form-group">
		<input type="hidden" name="id" value="<?php echo $info['id']; ?>">
		<input type="submit" class="btn-success btn" value="更新"></div>
</form>
        ...
        <nav class="quick-nav">
            ...
            <ul>
                ...
                <li>
                 ...
                 <li>
                    <a href="<?php echo url('personal/user'); ?>" >
                        <span>用户管理</span>
                        <i class="icon-user"></i>
                    </a>
                </li>
                <li>
                    <a href="<?php echo url('personal/cart'); ?>" >
                        <span>购物车管理</span>
                        <i class="icon-user"></i>
                    </a>
                </li>
...
<![endif]-->
        <!-- BEGIN CORE PLUGINS -->
        <script async="" src="__PUBLIC_ADMIN__/static/admin/gtm.js"></script><script async="" src="__PUBLIC_ADMIN__/static/admin/analytics.js"></script><script src="__PUBLIC_ADMIN__/static/admin/jquery_002.js" type="text/javascript"></script>
        <script src="__PUBLIC_ADMIN__/static/admin/bootstrap.js" type="text/javascript"></script>
        <script src="__PUBLIC_ADMIN__/static/admin/js.js" type="text/javascript"></script>
        <script src="__PUBLIC_ADMIN__/static/admin/jquery_003.js" type="text/javascript"></script>
        <script src="__PUBLIC_ADMIN__/static/admin/jquery.js" type="text/javascript"></script>
        <script src="__PUBLIC_ADMIN__/static/admin/bootstrap-switch.js" type="text/javascript"></script>
        <!-- END CORE PLUGINS -->
       ...
       <script src="__PUBLIC_ADMIN__/static/admin/theme2/layout.min.js" type="text/javascript"></script>
           
        <script src="__PUBLIC_ADMIN__/static/admin/quick-sidebar.js" type="text/javascript"></script>
        <script src="__PUBLIC_ADMIN__/static/admin/quick-nav.js" type="text/javascript"></script>
